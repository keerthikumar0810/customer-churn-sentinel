...
# Mock google.auth.default to prevent credentials exceptions in test environments
_mock_creds = unittest.mock.create_autospec(
    google.oauth2.credentials.Credentials, instance=True
)
google.auth.default = unittest.mock.MagicMock(
    return_value=(_mock_creds, "dummy-project-id")
)
